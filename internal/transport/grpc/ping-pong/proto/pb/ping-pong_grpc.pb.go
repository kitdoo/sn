...
func (c *pingPongClient) Ping(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*PingResponse, error) {
	out := new(PingResponse)
	err := c.cc.Invoke(ctx, "/sn.pingpong.v1.PingPong/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPingPongServer) Ping(context.Context, *emptypb.Empty) (*PingResponse, error) {
...
func _PingPong_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sn.pingpong.v1.PingPong/Ping",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingPongServer).Ping(ctx, req.(*emptypb.Empty))
	}
...
var PingPong_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sn.pingpong.v1.PingPong",
